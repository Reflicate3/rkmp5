...
/// Единый источник правды: хранит список, фильтры и навигацию.
...
class _ExercisesContainerState extends State<ExercisesContainer> {
  ...
  void _openFavorites() {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => FavoritesScreen(
        // Показываем все избранные, независимо от текущих фильтров
  ...
  void _createExercise({
    ...
    _showSnack('Упражнение «${ex.title}» добавлено');
  }
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
      ...
      child: ExercisesListScreen(
        ...
        onToggleFavorite: _toggleFavorite,
        onOpenDetail: _openDetail,
        // управление фильтрами и переходы
